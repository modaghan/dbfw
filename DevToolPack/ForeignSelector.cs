...
{
    public partial class ForeignSelector : DevExpress.XtraEditors.XtraForm
    {
        DbContext Context;
        Type ForeignType;
        public object Entity { get; set; }
        public ForeignSelector(DbContext ctx, Type foreign_type)
        {
            Context = ctx;
        ...
        private async void LoadDataSource(object sender = null, KeyEventArgs e = null)
        {
            ...
            grid.DataSource = await Task.Run(() =>
            {
